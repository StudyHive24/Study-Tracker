      ...
      <DialogContent className="p-8 bg-gray-800 border-none shadow-lg">
        <DialogHeader className="gap-2">
          <DialogTitle className="text-gray-100">
            Do you really want to Logout from StudyHive?
          </DialogTitle>
          ...
          <div className="flex items-center justify-center">
            ...
            <DialogPrimitive.Close>
              <Button
                onClick={logoutUser}
                className="bg-red-600 hover:bg-red-700 w-[13vw] mb-2 rounded-[10px] p-2"
              >
                <span onClick={logoutUser} className="text-white">
                  Logout
                </span>
              </Button>
            </DialogPrimitive.Close>
